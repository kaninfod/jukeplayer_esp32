...
_DATA_BAUDRATE = const(2_000_000)  # Speed for data transfers (reduced for messy breadboards)
# actual rate is 9MHz shared with SD card - sdcard.py uses 1.32MHz.
# RP2 rate is 10,416,666
_SCI_BAUDRATE = const(2_000_000)
...
#        return self._read_ram(_POS_MS_LS) | (self._read_ram(_POS_MS_MS) << 16)
    ...
    # @micropython.native  # Commented out for ESP32 compatibility
